...
class reset_m extends CI_Model {
	...
	public function get_order_by_reset($array=NULL) 
	{
		if($array != NULL) {
	...
	public function get_single_reset($array=NULL) 
	{
		if($array != NULL) {
	...
	public function insert_reset($array) 
	{
	...
	public function get_table_users($table, $email) 
	{
