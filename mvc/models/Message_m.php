...
class message_m extends MY_Model {
	...
	public function get_message($array=NULL, $signal=FALSE) 
	{
		$query = parent::get($array, $signal);
		return $query;
	}

	public function get_recivers($single=FALSE, $array=NULL) 
	{
		if ($array) {
	...
	public function get_order_by_message($array=NULL) 
	{
		$query = parent::get_order_by($array);
		return $query;
	}

	public function get_trash_message($email, $userID, $usertype) 
	{
	...
	public function update_message($data, $id = NULL) 
	{
