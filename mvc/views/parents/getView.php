...
<div class="well">
    <div class="row">
        <div class="col-sm-6">
            ...
            <?php
             echo btn_add_pdf('parents/print_preview/'.$parentsID, $this->lang->line('pdf_preview')) 
            ?>

            <?php if(permissionChecker('parents_edit')) { echo btn_sm_edit('parents/edit/'.$parentsID, $this->lang->line('edit')); } 
            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-title="<?=$this->lang->line('action')?>">
                                                        <?php 
                                                            ...
                                                            if(permissionChecker('parents_delete')) {
    ...
    $("#send_pdf").click(function(){
        ...
        if(error == 0) {
            ...
            $.ajax({
                ...
                data: 'to='+ to + '&subject=' + subject + "&parentsID=" + id+ "&message=" + message,
                dataType: "html",
                success: function(data) {
