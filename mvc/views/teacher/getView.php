    ...
    <div class="well">
        <div class="row">
            <div class="col-sm-6">
                ...
                <?=btn_add_pdf('teacher/print_preview/'.$teacherID, $this->lang->line('pdf_preview')) ?>

                <?php if(permissionChecker('teacher_edit')) { echo btn_sm_edit('teacher/edit/'.$teacherID, $this->lang->line('edit')); }
                ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-title="<?=$this->lang->line('action')?>">
                                                        <?php 
                                                            ...
                                                            if(permissionChecker('teacher_delete')) {
