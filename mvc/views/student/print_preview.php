    ...
    <div class="mainArea">
      <div class="areaTop">
        ...
        <div class="studentProfile">
          ...
          <div class="singleItem">
            <div class="single_label"><?=$this->lang->line('student_role')?></div>
      ...
      <div class="areaBottom">
        <table class="table table-bordered">
          <tr>
            ...
            <td width="70%"><?=count($studentgroup) ? $studentgroup->group : '' ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="70%"><?=isset($allbloodgroup[$student->bloodgroup]) ? $allbloodgroup[$student->bloodgroup] : ''?></td>
          </tr>
          <tr>
