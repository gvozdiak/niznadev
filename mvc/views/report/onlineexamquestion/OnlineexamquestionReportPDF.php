                ...
                <?php 
                    if(count($exam_questions)) {
                        ...
                        foreach($exam_questions as $exam_question) { 
                            if(isset($questions[$exam_question])) {
                                ...
                                <div class="question-answer">
                                    <table class="table">
                                        ...
                                        <?php
                                            $oc = 1;
                                            $tdCount = 0;
                                            $questionoptions = isset($question_options[$exam_question]) ? $question_options[$exam_question] : [];
...
<?php } elseif($typeID == 2) { ?>
    ...
    <div class="headerInfo">
        <h4 class="pull-left text-bold"><?=$this->lang->line('onlineexamquestionreport_exam')?> : <?=$exam->name?></h4>
        <h4 class="pull-right text-bold"><?=$this->lang->line('onlineexamquestionreport_duration')?> : <?=$exam->duration?> <?=$this->lang->line('onlineexamquestionreport_minute')?></h4>
    </div>
    <?php if(count($exam_questions)) { ?>
    <div class="userInfo">
    ...
    if(count($exam_questions)) {
        ...
        foreach($exam_questions as $exam_question) {
            if(isset($questions[$exam_question])) {
                ...
                $questionAnswers = isset($answers[$exam_question]) ? $answers[$exam_question] : [];
